...
import { User, Scan, Leaf, Crown, Settings, Info, ChevronRight, Mail, LogOut } from 'lucide-react-native';
...
export default function ProfileScreen() {
    ...
    const { stats } = useApp();
    const { profile, subscription, signOut, dailyScansRemaining } = useAuth();
    ...
    const handlePress = (action: string) => {
        ...
        switch (action) {
            ...
            case 'logout':
                ...
                break;
            default:
                logger.debug('Profile action triggered', { action });
        }
    };
